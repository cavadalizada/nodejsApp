...
export default class SignUp extends Component {
    ...
    handleClick = (event) => {
        ...
        axios.post(`http://localhost:3001/auth/register`, data,{headers:{
        ...
        <div className="auth-inner">
            <form>
                ...
                <div className="form-group">
                    <label>Name</label>
                    <input type="text" className="form-control" placeholder="Name" name = "name" onChange={this.handleChangeName}/>
                </div>
